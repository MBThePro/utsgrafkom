...
for (var i = 0; i < stackCount; ++i) {
	...
	var animate = function (time) {
		...
		//left_eye
		left_eye_kyle.setPosition(Math.PI / 2, 0.3, 0, -0.3, -1.2, 0.2, PHI, THETA);

		//right_eye
		right_eye_kyle.setPosition(Math.PI / 2, -0.3, 0, 0.3, -1.2, 0.2, PHI, THETA);

		//left_blackeye
		left_blackeye_kyle.setPosition(Math.PI / 2, 0.5, 0, -0.2, -1.4, 0.2, PHI, THETA);
		...
		//mouth
		mouth_kyle.setPosition(Math.PI / 2, 0, 0, 0.18, -1.1, -0.6, PHI, THETA);

		//hat_top
		hat_top_kyle.setPosition(0, 0, 0, 0, 0, 0.5, PHI, THETA);

		//hat_middle
		hat_middle_kyle.setPosition(0, 0, 0, 0, -0.2, 0.45, PHI, THETA);
		...
		//hat_back
		hat_back_kyle.setPosition(Math.PI / 2, 0, 0, 0, 1, 1.1, PHI, THETA);

		//body
		body_kyle.setPosition(0, 0, 0, 0, 0, -2.7, PHI, THETA);

		//left_arm
		left_arm_kyle.setPosition(0, 0.6, 0, -0.8, 0, -1.65, PHI, THETA);

		//right_arm
		right_arm_kyle.setPosition(0, -0.6, 0, 0.8, 0, -1.65, PHI, THETA);

		//right_elbow
		right_elbow_kyle.setPosition(0, 0, 0, 0.82, 0, -1.7, PHI, THETA);

		//left_elbow
		left_elbow_kyle.setPosition(0, -0.15, 0, -0.82, 0, -1.7, PHI, THETA);

		//left_forearm
		left_forearm_kyle.setPosition(0, 0.15, 0, -0.9, 0, -2.2, PHI, THETA);

		//right_forearm
		right_forearm_kyle.setPosition(0, -0.15, 0, 0.9, 0, -2.2, PHI, THETA);

		//left_hand
		left_hand_kyle.setPosition(0, 0, 0, -0.9, 0, -2.3, PHI, THETA);

		//right_hand
		right_hand_kyle.setPosition(0, 0, 0, 0.9, 0, -2.3, PHI, THETA);
		...
		//left_leg
		left_leg_kyle.setPosition(0, 0, 0, -0.38, 0, -3, PHI, THETA);

		//right_leg
		right_leg_kyle.setPosition(0, 0, 0, 0.38, 0, -3, PHI, THETA);

		//left_shoe
		left_shoe_kyle.setPosition(0, 0, 0, -0.38, -0.18, -3.08, PHI, THETA);

		//right_shoe
		right_shoe_kyle.setPosition(0, 0, 0, 0.38, -0.18, -3.08, PHI, THETA);
		...
		//back_sweater
		back_sweater_kyle.setPosition(-0.16, 0, 0, 0, 0.2, -1.235, PHI, THETA);
		...
		head_kyle.setuniformmatrix4(PROJMATRIX, VIEWMATRIX);
		head_kyle.draw();
